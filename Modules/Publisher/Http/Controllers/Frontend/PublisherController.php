    ...
    public function storeRegistration(Request $request): RedirectResponse|JsonResponse
    {
        ...
        if ($request->expectsJson() || $request->ajax()) {
            return response()->json([
                'success'      => true,
                'message'      => 'অভিনন্দন! প্রকাশনী হিসেবে আপনার রেজিস্ট্রেশন সফলভাবে সম্পন্ন হয়েছে।',
                'redirect_url' => route('publisher.dashboard'),
            ]);
        }

        return redirect()->route('publisher.dashboard')
            ->with('success', 'অভিনন্দন! প্রকাশনী হিসেবে আপনার প্রোফাইল সফলভাবে তৈরি হয়েছে। আপনার ড্যাশবোর্ড থেকে প্রকাশিত বই ও ইনভেন্টরি যুক্ত করুন।');
    }
