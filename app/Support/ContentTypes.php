        ...
        return [
            ...
            'ebooks' => [
                ...
                'fields'    => [
                    ...
                    'category_id'     => ['label' => 'Category',          'type' => 'select', 'lookup' => 'categories', 'rules' => 'nullable|integer', 'col' => 6],
                    'publisher_id'    => ['label' => 'Publisher',         'type' => 'select', 'lookup' => 'publishers', 'rules' => 'nullable|integer', 'col' => 6],
                    'author_id'       => ['label' => 'Author',            'type' => 'select', 'lookup' => 'authors',    'rules' => 'nullable|integer', 'col' => 6],
                    'author_name'     => ['label' => 'Author Name',       'type' => 'text',   'rules' => 'nullable|string|max:255',    'col' => 6],
                    'editor_name'     => ['label' => 'Editor Name',       'type' => 'text',   'rules' => 'nullable|string|max:255',    'col' => 4],
                    'rewriter_name'   => ['label' => 'Rewriter Name',     'type' => 'text',   'rules' => 'nullable|string|max:255',    'col' => 4],
                    'translator_name' => ['label' => 'Translator Name',   'type' => 'text',   'rules' => 'nullable|string|max:255',    'col' => 4],
                    ...
                    'is_royalty_free' => ['label' => 'Royalty-Free E-Book (রয়্যালটি ফ্রি ইবুক — কোনো রয়্যালটি প্রযোজ্য নয়)', 'type' => 'checkbox', 'rules' => 'nullable|boolean', 'col' => 6],
                    'royalty_percentage' => ['label' => 'Author Royalty Share (%) [Standard: 50%]', 'type' => 'number', 'default' => 50, 'rules' => 'nullable|numeric|min:0|max:100', 'col' => 6],
            ...
            'authors' => [
                ...
                'icon'      => 'pen-fancy',
                'fields'    => [
                    'name_bn'     => ['label' => 'Author Name (bangla) (এই নামটা ব্লগ ও বইয়ে শো করবে)', 'type' => 'text', 'rules' => 'required|string|max:255', 'col' => 6],
                    'name_en'     => ['label' => 'Author Name (english)', 'type' => 'text', 'rules' => 'required|string|max:255', 'col' => 6],
                    'phone'       => ['label' => 'Mobile No (uid)', 'type' => 'text', 'rules' => 'nullable|string|max:30', 'col' => 6],
                    'email'       => ['label' => 'Email', 'type' => 'text', 'rules' => 'nullable|email|max:255', 'col' => 6],
                    'website'     => ['label' => 'Website', 'type' => 'text', 'rules' => 'nullable|url|max:255', 'col' => 6],
                    'avatar'      => ['label' => 'Photo', 'type' => 'file', 'accept' => 'image/*', 'disk' => 'authors', 'rules' => 'nullable|image|max:4096', 'col' => 6],
                    'bio'         => ['label' => 'Bio', 'type' => 'editor', 'rules' => 'nullable|string|max:20000', 'col' => 12],
            ...
            'blog' => [
                ...
                'fields'    => [
                    ...
                    'is_royalty_free'    => ['label' => 'Royalty-Free / Non-Royalty Post (রয়্যালটি ফ্রি — কোনো সম্মানী প্রযোজ্য নয়)', 'type' => 'checkbox', 'rules' => 'nullable|boolean', 'col' => 6],
                    'royalty_percentage' => ['label' => 'Author Honorarium Share (%) [Standard: 70%]', 'type' => 'number', 'default' => 70, 'rules' => 'nullable|numeric|min:0|max:100', 'col' => 6],
