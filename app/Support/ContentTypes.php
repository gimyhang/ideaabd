    ...
    public static function all(): array
    {
        return [
            'books' => [
                ...
                'icon'      => 'book',
                'fields'    => [
                    // --- ১. বইয়ের মূল তথ্য ও লেখক/অনুবাদক/সম্পাদক (Basic & Contributors) ---
                    'title'                   => ['label' => 'বইয়ের নাম',        'type' => 'text',             'rules' => 'required|string|max:255',                                    'col' => 8],
                    'sku'                     => ['label' => 'বই কোড / SKU',      'type' => 'text',             'rules' => 'nullable|string|max:50',                                     'col' => 4],
                    'subtitle'                => ['label' => 'সাব-টাইটেল',        'type' => 'text',             'rules' => 'nullable|string|max:500',                                    'col' => 8],
                    'isbn'                    => ['label' => 'ISBN নম্বর',        'type' => 'text',             'rules' => 'nullable|string|max:30',                                     'col' => 4],
                    'author_role_group'       => ['label' => 'লেখক / অনুবাদক / সম্পাদক', 'type' => 'author_role_group', 'lookup' => 'authors', 'rules' => 'nullable|string|max:30', 'col' => 12],
                    'translator_name'         => ['label' => 'অনুবাদকের নাম (যদি থাকে)', 'type' => 'text',      'placeholder' => 'যেমন: খালিকুজ্জামান ইলিয়াস', 'rules' => 'nullable|string|max:255', 'col' => 4],
                    'editor_name'             => ['label' => 'সম্পাদকের নাম (যদি থাকে)', 'type' => 'text',      'placeholder' => 'যেমন: ড. মুহম্মদ শহীদুল্লাহ', 'rules' => 'nullable|string|max:255', 'col' => 4],
                    'cover_artist'            => ['label' => 'প্রচ্ছদ শিল্পী (Cover Artist)', 'type' => 'text', 'placeholder' => 'যেমন: ধ্রুব এষ / কাইয়ুম চৌধুরী', 'rules' => 'nullable|string|max:255', 'col' => 4],
                    ...
                    'price'                   => ['label' => 'পেপারব্যাক নিয়মিত মূল্য (৳)', 'type' => 'number', 'default' => 0, 'step' => '0.01', 'rules' => 'nullable|numeric|min:0|max:9999999', 'col' => 4],
                    'discount_price'          => ['label' => 'পেপারব্যাক ছাড়ের বিক্রয়মূল্য (৳)', 'type' => 'number', 'step' => '0.01',       'rules' => 'nullable|numeric|min:0|max:9999999', 'col' => 4],
                    'cost_price'              => ['label' => 'ক্রয়মূল্য / খরচ (৳ - ঐচ্ছিক)', 'type' => 'number', 'step' => '0.01',          'rules' => 'nullable|numeric|min:0|max:9999999', 'col' => 4],

                    // --- ৩. প্রকাশনা, রিলিজ ও ইনভেন্টরি (Release & Stock) ---
                    'published_at'            => ['label' => 'প্রকাশের তারিখ / সাল', 'type' => 'date',            'rules' => 'nullable|date',                                              'col' => 4],
                    'edition'                 => ['label' => 'সংস্করণ / মুদ্রণ',    'type' => 'text',             'placeholder' => 'যেমন: ১ম প্রকাশ ২০২৬ / পরিমার্জিত সংস্করণ', 'rules' => 'nullable|string|max:100', 'col' => 4],
                    ...
                    'pre_order_release_date'  => ['label' => 'প্রি-অর্ডারের সম্ভাব্য প্রকাশ / ডেলিভারি তারিখ', 'type' => 'date', 'rules' => 'nullable|date', 'col' => 6],
                    'pre_order_note'          => ['label' => 'প্রি-অর্ডারের বিশেষ বার্তা / অফার নোট', 'type' => 'textarea', 'placeholder' => 'যেমন: প্রি-অর্ডারে লেখকের অটোগ্রাফ ও বিশেষ বুকমার্ক উপহার...', 'rules' => 'nullable|string|max:1000', 'col' => 6],
                    'stock_quantity'          => ['label' => 'স্টক পরিমাণ (সংখ্যা)', 'type' => 'number',         'default' => 10,           'rules' => 'nullable|integer|min:0|max:1000000',    'col' => 4],

                    // --- ৪. বইয়ের শারীরিক বিবরণ ও মাপ (Physical Specs) ---
                    'book_size'               => ['label' => 'বইয়ের মাপ / সাইজ',   'type' => 'text',             'placeholder' => 'যেমন: ডিমাই ১/৮, রয়্যাল, ৫.৫" × ৮.৫", A5', 'rules' => 'nullable|string|max:100', 'col' => 4],
                    'page_count'              => ['label' => 'মোট পৃষ্ঠা সংখ্যা',  'type' => 'number',           'default' => 0,            'rules' => 'nullable|integer|min:0|max:50000',      'col' => 4],
                    'paper_type'              => ['label' => 'কাগজের মান / ধরন',  'type' => 'text',             'placeholder' => 'যেমন: ৮০ জিএসএম ক্রিম পেপার / অফসেট', 'rules' => 'nullable|string|max:100', 'col' => 4],
                    'weight'                  => ['label' => 'বইয়ের ওজন (গ্রাম)', 'type' => 'number',           'placeholder' => 'যেমন: ৩৫০', 'rules' => 'nullable|integer|min:0|max:50000',     'col' => 4],
                    'preview_pages'           => ['label' => 'অনলাইন প্রিভিউ পৃষ্ঠা', 'type' => 'number',        'default' => 0,            'rules' => 'nullable|integer|min:0|max:10000',      'col' => 4],

                    // --- ৫. মিডিয়া, কভার ও স্যাম্পল ফাইল (Media & Files) ---
                    'cover_image'             => ['label' => 'কভার ছবি (২:৩ স্ট্যান্ডার্ড)', 'type' => 'file',   'accept' => 'image/*',     'disk' => 'books',                          'rules' => 'nullable|image|max:4096',                  'col' => 4],
                    'author_image'            => ['label' => 'লেখকের ছবি (১:১ স্কয়ার)', 'type' => 'file',   'accept' => 'image/*',     'disk' => 'authors',                        'rules' => 'nullable|image|max:4096',                  'col' => 4],
                    'sample_pdf_path'         => ['label' => 'নমুনা PDF ফাইল (প্রিভিউ)', 'type' => 'file',       'accept' => 'application/pdf', 'disk' => 'books/samples',              'rules' => 'nullable|file|mimetypes:application/pdf|max:20480', 'col' => 4],

                    // --- ৬. সারসংক্ষেপ, ফ্ল্যাপ ও লেখক পরিচিতি (Flap & Bio) ---
                    ...
                    'author_bio'              => ['label' => 'লেখক পরিচিতি (কাস্টম/ঐচ্ছিক বায়ো)', 'type' => 'textarea', 'rules' => 'nullable|string|max:10000', 'col' => 12],
                    'is_active'               => ['label' => 'সাইটে সক্রিয় ও দৃশ্যমান থাকবে', 'type' => 'checkbox',       'rules' => 'nullable|boolean',                                          'col' => 12],
                ],
            ],
            ...
            'blog' => [
                ...
                'icon'      => 'blog',
                'fields'    => [
                    'title'          => ['label' => 'মূল শিরোনাম (Headline)', 'type' => 'text', 'rules' => 'required|string|max:255', 'col' => 12],
                    'author_id'      => ['label' => 'লেখক (Author)', 'type' => 'select', 'rules' => 'nullable|string|max:100', 'col' => 6],
                    'category_id'    => ['label' => 'ক্যাটাগরি (Category)', 'type' => 'select', 'lookup' => 'blog_categories', 'rules' => 'nullable|integer', 'col' => 6],
                    'subtitle'       => ['label' => 'উপ-শিরোনাম বা বিশেষ ট্যাগলাইন (Subtitle)', 'type' => 'text', 'rules' => 'nullable|string|max:500', 'col' => 12],
                    'excerpt'        => ['label' => 'সারসংক্ষেপ / এক নজরে (Excerpt)', 'type' => 'textarea', 'rules' => 'nullable|string|max:1000', 'col' => 12],
                    'content'        => ['label' => 'মূল লেখা (কবিতা / প্রবন্ধ / গল্প)', 'type' => 'editor', 'rules' => 'required|string|max:100000', 'col' => 12],
                    'featured_image' => ['label' => 'ফিচার্ড কভার ছবি / ফটোকার্ড', 'type' => 'file', 'accept' => 'image/*', 'disk' => 'blog', 'rules' => 'nullable|image|max:8192', 'col' => 6],
