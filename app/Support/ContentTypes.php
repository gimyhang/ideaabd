    ...
    public static function all(): array
    {
        return [
            'books' => [
                ...
                'icon'      => 'book',
                'fields'    => [
                    // --- ১. বইয়ের মূল তথ্য (Basic Information) ---
                    ...
                    // --- ৩. ইনভেন্টরি, স্টক ও শারীরিক বিবরণ (Inventory & Physical Specs) ---
                    ...
                    'paper_type'              => ['label' => 'কাগজের মান / ধরন',  'type' => 'text',             'placeholder' => 'উদা: ৮০ জিএসএম ক্রিম পেপার / অফসেট', 'rules' => 'nullable|string|max:100', 'col' => 4],
                    ...
                    // --- ৪. মিডিয়া, কভার ও স্যাম্পল ফাইল (Media & Files) ---
                    ...
                    // --- ৫. সারসংক্ষেপ, ফ্ল্যাপ ও লেখক পরিচিতি (Flap & Bio) ---
