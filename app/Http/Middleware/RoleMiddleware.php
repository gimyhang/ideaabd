...
class RoleMiddleware
{
    ...
    public const ROUTE_PERMISSION_MAP = [
        ...
        'admin.accounting.invoices.export'         => 'accounting.view',
        'admin.accounting.invoices.bulk-action'    => 'accounting.ledger_manage',
        ...
        'admin.accounting.invoices.quick-payment'  => 'accounting.ledger_manage',
        'admin.accounting.invoices.duplicate'      => 'accounting.ledger_manage',
        'admin.accounting.invoices.quick-sms'      => 'accounting.ledger_manage',
        ...
        'admin.customer-registrations'             => 'users.view',
        'admin.customers.toggle-verification'      => 'users.manage',
        'admin.customers.broadcast'                => 'support.broadcast',
        'admin.sms.index'                          => 'support.broadcast',
        'admin.sms.balance'                        => 'support.broadcast',
        'admin.sms.send-test'                      => 'support.broadcast',
        'admin.sms.broadcast'                      => 'support.broadcast',
        'admin.sms.settings'                       => 'settings.manage',
        'admin.sms.send-email-test'                => 'support.broadcast',
        'admin.sms.broadcast-email'                => 'support.broadcast',
        'admin.sms.smtp-settings'                  => 'settings.manage',
        'admin.sms.send-otp-test'                  => 'support.broadcast',
        'admin.sms.broadcast-dual'                 => 'support.broadcast',
        ...
        'admin.event-campaigns.index'              => 'users.view',
        'admin.event-campaigns.create'             => 'users.manage',
        'admin.event-campaigns.store'              => 'users.manage',
        'admin.event-campaigns.show'               => 'users.view',
        'admin.event-campaigns.edit'               => 'users.manage',
        'admin.event-campaigns.update'             => 'users.manage',
        'admin.event-campaigns.destroy'            => 'users.manage',
        'admin.event-campaigns.clone'              => 'users.manage',
        'admin.event-campaigns.toggle-status'      => 'users.manage',
        'admin.event-campaigns.update-title'       => 'users.manage',
        'admin.event-campaigns.table-settings'     => 'users.manage',
        'admin.event-campaigns.card-design'        => 'users.manage',
        'admin.event-campaigns.upload-object'      => 'users.manage',
        'admin.event-campaigns.registrations.store' => 'users.manage',
        'admin.event-campaigns.registrations.update' => 'users.manage',
        'admin.event-campaigns.registrations.destroy' => 'users.manage',
        'admin.event-campaigns.registrations.toggle-scholarship' => 'users.manage',
        'admin.event-campaigns.registrations.toggle-approval' => 'users.manage',
        'admin.event-campaigns.registrations.viva-evaluation' => 'users.manage',
        'admin.event-campaigns.registrations.print' => 'users.view',
        'admin.event-campaigns.registrations.pdf'   => 'users.view',
