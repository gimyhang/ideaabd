...
@section('title', 'নতুন বিল ও চালান তৈরি (POS) — আইডিয়া প্রকাশন')
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4 bg-white overflow-hidden">
                <div class="card-header bg-white py-3 border-bottom d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            <h5 class="fw-bold mb-0 text-dark">বিল ও চালান তৈরি ফরম</h5>
                        ...
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" name="reference_no" class="form-control form-control-sm bg-white" 
                                       placeholder="উদা: IDEA-CH/2026/08" value="{{ old('reference_no') }}">
                            </div>
                            <div class="col-12 mt-2">
                                ...
                                <input type="text" name="subject" id="docSubjectInput" class="form-control form-control-sm bg-white" 
                                       placeholder="উদা: লাইব্রেরি বা গ্রাহকের অনুকূলে নতুন বই সরবরাহ ও বিক্রয় চালান" value="{{ old('subject') }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-sm-6 col-lg-4">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="customer_name" class="form-control" value="{{ old('customer_name') }}" required placeholder="উদা: মো: সাইফুল ইসলাম">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-lg-4">
                                <label class="form-label small fw-semibold">প্রতিষ্ঠান / লাইব্রেরির নাম (ঐচ্ছিক)</label>
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-light"><i class="fas fa-building text-muted"></i></span>
                                    <input type="text" name="customer_org" class="form-control" value="{{ old('customer_org') }}" placeholder="উদা: প্রগতি বুক ডিপো / আইডিয়াল স্কুল">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-lg-4">
                                <label class="form-label small fw-semibold">পদবী / পরিচিতি (ঐচ্ছিক)</label>
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-badge text-muted"></i></span>
                                    <input type="text" name="customer_designation" class="form-control" value="{{ old('customer_designation') }}" placeholder="উদা: লাইব্রেরিয়ান / স্বত্বাধিকারী">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-lg-4">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="customer_address" class="form-control" value="{{ old('customer_address') }}" placeholder="দোকান/বাসার ঠিকানা, থানা, জেলা">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered align-middle mb-0" id="itemsTable">
                            ...
                            <tbody id="itemsBody">
                                ...
                                <tr class="item-row" data-index="0">
                                    <td class="text-center text-muted fw-bold row-index">১</td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" name="items[0][author]" class="form-control form-control-sm item-author-input" placeholder="লেখকের নাম...">
                                    </td>
                                    <td>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 h-100 p-3 p-md-4 bg-white">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="notes" class="form-control form-control-sm" rows="3" 
                                      placeholder="উদা: মেমো যাচাইকৃত। কাস্টমারকে স্পেশাল পার্সেল ডেলিভারি দেয়া হয়েছে...">{{ old('notes') }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="terms_conditions" class="form-control form-control-sm" rows="3" 
                                      placeholder="উদা: বিক্রিত বই ফেরতযোগ্য নয়। ত্রুটিযুক্ত বই ৭ দিনের মধ্যে পরিবর্তনযোগ্য।">{{ old('terms_conditions', '১. বিক্রিত বই ফেরতযোগ্য নয়। ত্রুটিযুক্ত বই ৭ দিনের মধ্যে পরিবর্তনযোগ্য।') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="card border-0 shadow-sm rounded-4 p-3 p-md-4 bg-white">
                        ...
                        <div class="d-flex flex-column gap-2 mb-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-muted small">আইটেম অনুযায়ী ছাড় (Item Discounts):</span>
                            ...
                            <div class="row g-2 pt-2 border-top">
                                <div class="col-6">
                                    ...
                                    <select name="payment_method" class="form-select form-select-sm" required>
                                        ...
                                        <option value="card" @selected(old('payment_method')==='card')>💳 ব্যাংক / কার্ড</option>
                                    </select>
                                </div>
                                <div class="col-6">
            ...
            <div class="card border-0 shadow-sm rounded-4 bg-white mb-5">
                <div class="card-body p-3 d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <a href="{{ route('subadmin.bills.index') }}" class="btn btn-outline-secondary rounded-pill px-4">
                        <i class="fas fa-arrow-left me-1"></i> বিল তালিকায় ফিরুন
                    </a>
                    <div class="d-flex flex-wrap gap-2">
                        <button type="submit" class="btn btn-primary rounded-pill px-4 fw-bold shadow-sm" id="submitBillBtn">
                            <i class="fas fa-check-circle me-1.5"></i> সংরক্ষণ ও মেমো দেখুন
                        </button>
                    </div>
                </div>
            </div>
...
function updateDocType(type) {
    ...
    if (type === 'challan') {
        ...
        if (!subject.value) subject.value = 'বই সরবরাহ ও ডেলিভারি চালান';
        ...
        if (!subject.value) subject.value = 'বই ক্রয়ের সম্ভাব্য দরপ্রস্তাব / কোটেশন';
    } else {
        ...
        if (!subject.value) subject.value = 'বই বিক্রয় ক্যাশ মেমো / ইনভয়েস';
    }
}
