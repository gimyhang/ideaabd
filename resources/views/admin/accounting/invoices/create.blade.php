    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4 bg-white">
        <div class="card-header bg-white py-3 border-bottom d-flex flex-wrap justify-content-between align-items-center gap-2">
            <h5 class="fw-bold mb-0 text-primary">
                <i class="fa-solid fa-file-invoice me-2"></i>Document & Client Information
            </h5>
            ...
            <div class="card border-0 shadow-sm rounded-4 bg-white">
                ...
                <div class="card-body p-3.5 p-md-4">
                    ...
                    <div id="paymentFieldsSection">
                        <hr class="my-3">
                        <h6 class="fw-bold text-dark mb-3"><i class="fa-solid fa-money-bill-wave me-2 text-primary"></i>Payment & Settlement</h6>
                    ...
                    <button type="submit" id="submitBtn" class="btn btn-success w-100 py-3 rounded-pill fw-bold shadow-sm">
                        <i class="fa-solid fa-circle-check me-1.5"></i> Save & Generate Document
                    </button>
...
<script>
    ...
    function updateDocType() {
        ...
        if (docType === 'tender') {
            ...
            submitBtn.innerHTML = '<i class="fa-solid fa-landmark me-1.5"></i> Save Tender Proposal & Schedule';
            ...
            submitBtn.innerHTML = '<i class="fa-solid fa-file-lines me-1.5"></i> Save & Generate Price Quotation';
            ...
            submitBtn.innerHTML = '<i class="fa-solid fa-truck me-1.5"></i> Save & Issue Delivery Challan';
            ...
            submitBtn.innerHTML = '<i class="fa-solid fa-receipt me-1.5"></i> Save & Issue Bill / Invoice';
