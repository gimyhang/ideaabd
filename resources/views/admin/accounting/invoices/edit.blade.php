                        ...
                        <table class="table table-bordered align-middle mb-0" id="itemsTable" style="min-width: 1420px;">
                            ...
                            <tbody id="itemsBody">
                                @php
                                    ...
                                    if (empty($items)) {
                                        $items = [['title' => '', 'item_type' => 'Book (Paperback)', 'unit' => 'কপি', 'quantity' => 1, 'unit_price' => 0, 'subtotal' => 0]];
                                    }
                                @endphp
                                    ...
                                    <tr class="item-row" data-row="{{ $i }}">
                                        <td>
                                            <input type="text" name="items[{{ $i }}][title]" class="form-control item-title fw-semibold" 
                                                   placeholder="Type or enter item title..." value="{{ $item['title'] ?? '' }}" required oninput="onTitleInput(this, {{ $i }})" onchange="onTitleInput(this, {{ $i }})" autocomplete="off">
        ...
        tr.innerHTML = `
            ...
            <td>
                <select name="items[${i}][item_type]" class="form-select item-type-select" onchange="onTypeChange(this, ${i})">
                    ...
                    <option value="Tender Publication">Tender Publication</option>
