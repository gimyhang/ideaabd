...
<script>
    ...
    function updateDocType() {
        ...
        // Reset Classes
        if (tenderPanel) tenderPanel.className = 'p-3.5 rounded-3 border mb-3';
        ...
        if (docType === 'quotation' || docType === 'tender') {
            ...
            if (docType === 'tender') {
                if (tenderPanel) tenderPanel.classList.add('bg-indigo-subtle', 'border-indigo-subtle');
                ...
                if (tenderPanel) tenderPanel.classList.add('bg-warning-subtle', 'bg-opacity-25', 'border-warning-subtle');
