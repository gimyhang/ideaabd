            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4 bg-white">
                <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <small class="text-muted" id="itemsSectionSubtitle">Selecting books from catalog will automatically populate author, cover price and discount</small>
                    </div>
                                    ...
                                    <tr class="item-row" data-row="{{ $i }}">
                                        ...
                                        <td>
                                            <input type="text" name="items[{{ $i }}][author_name]" class="form-control form-control-sm item-author" 
                                                   placeholder="Author / Spec" value="{{ $authorName }}">
                                        </td>
                                        <td>
