                ...
                <div class="author-card p-3 p-md-4 mb-4">
                    ...
                    @if($ebook->mod_status === 'rejected' && $ebook->rejection_reason)
                        <div class="alert alert-danger rounded-3 d-flex align-items-start gap-2 mb-4">
                            ...
                            <div>
                                <strong class="d-block">Revision Required:</strong>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-12">
                            <textarea id="f-description" name="description" rows="4" required
                                      ...
                                      placeholder="Book summary, description and table of contents...">{{ old('description', $ebook->description) }}</textarea>
                            ...
                            <div class="p-3 rounded-3 border bg-light bg-opacity-50">
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    <label for="f-file_path" class="form-label small fw-bold text-dark mb-0">
                                        Update File (PDF / EPUB - Optional)
                                    </label>
                                    <span class="badge bg-secondary-subtle text-secondary font-monospace" style="font-size: 11px;">Max 100 MB</span>
                                </div>
                ...
                <div class="author-card p-3 p-md-4 shadow-sm">
                    ...
                    <div>
                        <label for="f-cover_image" class="form-label small fw-bold text-dark mb-1">
                            <i class="fas fa-upload text-secondary me-1"></i> Upload New Cover (Optional)
                        </label>
