...
const isDefault = defaultRoles.includes(props.role.name.toLowerCase());
...
function submit() {
    form.put(`/admin/roles/${props.role.name}`);
}
</script>

<template>
    <Head :title="`Edit Role: ${role.name} — Admin Portal`" />
    ...
    <AdminLayout>
        ...
        <div class="max-w-4xl mx-auto space-y-6 font-sans">
            ...
            <nav class="flex items-center gap-2 text-xs text-slate-400">
                ...
                <span>/</span>
                <span class="font-bold text-slate-200">Edit {{ role.name }}</span>
            </nav>

            <!-- Card Container matching user's Image 2 -->
            <div
            ...
            >
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="space-y-1">
                            <Input
                                ...
                                required
                            />
                            <p v-if="isDefault" class="text-xs text-slate-400 font-medium pt-0.5">
                    ...
                    <!-- Bottom Action Buttons matching user's Image 2 -->
