...
<head>
    ...
    <title>Invoice {{ $invoice->invoice_number }} — BookVerse</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 0;
...
<body>
    ...
    <div class="page-container">
        ...
        <table class="header-table">
            <tr>
                <td style="width: 50%;">
                    ...
                    <div style="font-size: 11px; color: #64748b;">Dhaka, Bangladesh | support@bookverse.com</div>
                </td>
        ...
        <!-- Footer Disclaimer -->
        <div class="footer">
            Thank you for purchasing from BookVerse Library! For any billing queries, contact support@bookverse.com.
            <br>
